...
function Task_1_InstructionsRoutineBegin(snapshot) {
  return function () {
    ...
    Task_1_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function items_presentationRoutineBegin(snapshot) {
  return function () {
    ...
    items_presentationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function next_stepRoutineBegin(snapshot) {
  return function () {
    ...
    next_stepComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Task_2_instructionsRoutineBegin(snapshot) {
  return function () {
    ...
    Task_2_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_recoRoutineBegin(snapshot) {
  return function () {
    ...
    test_recoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function accuracy_and_feedback_1RoutineBegin(snapshot) {
  return function () {
    ...
    accuracy_and_feedback_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Task_4_InstructionsRoutineBegin(snapshot) {
  return function () {
    ...
    Task_4_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_premiceRoutineBegin(snapshot) {
  return function () {
    ...
    test_premiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Taux_réussite_et_feedback_3RoutineBegin(snapshot) {
  return function () {
    ...
    Taux_réussite_et_feedback_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Tache_5_instructionsRoutineBegin(snapshot) {
  return function () {
    ...
    Tache_5_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_last_premRoutineBegin(snapshot) {
  return function () {
    ...
    test_last_premComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function taux_réussite_et_feedback_4RoutineBegin(snapshot) {
  return function () {
    ...
    taux_réussite_et_feedback_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Fin_session_1RoutineBegin(snapshot) {
  return function () {
    ...
    Fin_session_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
