...
function BienvenueRoutineBegin(snapshot) {
  return function () {
    ...
    BienvenueComponents.forEach( function(thisComponent) {
...
function Tache_1_instructionsRoutineBegin(snapshot) {
  return function () {
    ...
    Tache_1_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_infRoutineBegin(snapshot) {
  return function () {
    ...
    test_infComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
